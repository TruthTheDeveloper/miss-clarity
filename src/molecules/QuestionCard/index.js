...
const QuestionCard = ({  question, answers, changeOpenState, open }) => {
  return (
    <>
      <div className=" border-[#303237] border-[0.74px] rounded-[7.36px] justify-between w-[350.76px] ] items-center px-2 my-4 md:w-[300px] lg:w-[400px] cursor-pointer " onClick={() => changeOpenState()}>

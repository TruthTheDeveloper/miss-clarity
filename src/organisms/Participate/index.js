    ...
    <div className=" relative w-[360px] h-[959px] mx-auto  ">
      ...
      >
        ...
        <ParticipateCard
          ...
          color={"bg-light-pink"}
        />
        <div className="border-deep-pink w-[100px] h-[15px] ml-[80px] border-0 border-r-4"></div>
        <div className="bg-deep-pink w-[49.11px] h-[49.11px] border-r-2 mx-auto text-center  rounded-full">
